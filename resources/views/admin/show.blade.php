...
<body class="bg-gray-50 text-gray-800 font-sans">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-3xl font-bold text-gray-900">Review Pendaftar: {{ $enrollment->user->name ?? $enrollment->nama }}</h1>
                        <span
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="1">
                            ...
                            <div class="px-6 py-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->nis ?? '-' }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->nik ?? '-' }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Agama</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->agama ?? '-' }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Kebutuhan Khusus</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->kebutuhankhusus ?? 'Tidak Ada' }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg md:col-span-2">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Alamat Rumah</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->alamat_rumah ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="2">
                            <div class="px-6 py-5 border-b border-gray-200 bg-[#009CE0]">
                            ...
                            <div class="border-b border-gray-200 bg-gray-50">
                                <div class="flex flex-wrap">
                                    <button type="button" class="parent-tab flex-1 py-4 px-6 font-medium focus:outline-none transition active" data-tab="ayah">Ayah</button>
                                    <button type="button" class="parent-tab flex-1 py-4 px-6 font-medium focus:outline-none transition" data-tab="ibu">Ibu</button>
                                    <button type="button" class="parent-tab flex-1 py-4 px-6 font-medium focus:outline-none transition" data-tab="wali">Wali</button>
                                </div>
                            </div>
                                ...
                                <div class="parent-tab-content" id="ayah-tab">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->nama_ayah ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pendidikan Ayah</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pendidikan_ayah ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pekerjaan Ayah</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pekerjaan_ayah ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Penghasilan Ayah</p>
                                            <p class="text-sm font-semibold text-gray-900">Rp {{ number_format($enrollment->user->orangtua->penghasilan_ayah ?? 0, 0, ',', '.') }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="parent-tab-content hidden" id="ibu-tab">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->nama_ibu ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pendidikan Ibu</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pendidikan_ibu ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pekerjaan Ibu</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pekerjaan_ibu ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Penghasilan Ibu</p>
                                            <p class="text-sm font-semibold text-gray-900">Rp {{ number_format($enrollment->user->orangtua->penghasilan_ibu ?? 0, 0, ',', '.') }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="parent-tab-content hidden" id="wali-tab">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->nama_wali ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pendidikan Wali</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pendidikan_wali ?? '-' }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-4 rounded-lg">
                                            <p class="text-xs font-medium text-gray-600 mb-1">Pekerjaan Wali</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->orangtua->pekerjaan_wali ?? '-' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="3">
                            <div class="px-6 py-5 border-b border-gray-200 bg-[#009CE0]">
                                ...
                                @forelse ($enrollment->user->prestasi ?? [] as $prestasi)
                                    <div class="border border-gray-200 rounded-lg p-4 bg-gray-50 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-semibold text-gray-900">{{ $prestasi->tingkat }}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs font-medium text-gray-600 mb-1">Tahun & Penyelenggara</p>
                                            <p class="text-sm font-semibold text-gray-900">{{ $prestasi->tahun }} - {{ $prestasi->penyelenggara }}</p>
                                        </div>
                                    </div>
                                @empty
                        ...
                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="4">
                            <div class="px-6 py-5 border-b border-gray-200 bg-[#009CE0]">
                            ...
                            <div class="px-6 py-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->dataPeriodik->tinggi_badan ?? '-' }} cm</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Berat Badan</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->dataPeriodik->berat_badan ?? '-' }} kg</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Jarak ke Sekolah</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->dataPeriodik->jarak ?? '-' }} km</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Waktu ke Sekolah</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->dataPeriodik->waktu ?? '-' }} menit</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <p class="text-xs font-medium text-gray-600 mb-1">Jumlah Saudara</p>
                                        <p class="text-sm font-semibold text-gray-900">{{ $enrollment->user->dataPeriodik->jumlahsaudara ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="5">
                            <div class="px-6 py-5 border-b border-gray-200 bg-[#009CE0]">
                                <h3 class="text-lg leading-6 font-medium text-white">Dokumen</h3>
                                <p class="mt-1 text-sm text-gray-100">Dokumen pendukung yang diajukan dalam pendaftaran</p>
                            </div>
                                        ...
                                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition bg-gray-50">
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    ...
                                                    @if($path)
                                                        <a href="{{ asset('storage/' . $path) }}" target="_blank" class="mt-2 inline-flex items-center text-sm text-blue-600 hover:text-blue-800 font-medium">
                                                            Lihat File <span class="ml-1">→</span>
                                                        </a>
                                                    @else
                                                        <span class="mt-2 inline-flex items-center text-sm text-red-500 font-medium">Belum Diunggah</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="review-step-container bg-white shadow rounded-lg overflow-hidden hidden" data-step="6">
                            <div class="px-6 py-5 border-b border-gray-200 bg-[#009CE0]">
                                <h3 class="text-lg leading-6 font-medium text-white">Keputusan</h3>
                                <p class="mt-1 text-sm text-gray-100">Berikan keputusan dan ubah status verifikasi pendaftaran</p>
                            </div>
                            ...
                            <div class="px-6 py-6">
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                    <div class="flex">
                                        ...
                                        <p class="text-sm text-blue-800">Pastikan semua informasi data telah diverifikasi sesuai persyaratan.</p>
                                    </div>
                                </div>

                                <form action="{{ route('admin.enrollment.update-status', $enrollment->id) }}" method="POST" class="space-y-4">
                                    @csrf
                                    @method('PATCH')

                                    <div>
                                        <label for="status" class="block text-sm font-medium text-gray-700 mb-3">Tetapkan Status</label>
                                        <select name="status" id="status" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#009CE0] focus:border-transparent">
                                            <option value="Menunggu" {{ $enrollment->status === 'Menunggu' ? 'selected' : '' }}>⏳ Menunggu</option>
                                    ...
                                    <button type="submit" class="w-full inline-flex justify-center items-center py-3 px-6 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-[#009CE0] hover:bg-blue-700 transition">
                                        Simpan Keputusan
                                    </button>
                                </form>
                            </div>
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg" style="z-index: 50;">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                        <div class="flex justify-between items-center">
                            <button type="button" id="prevBtn" class="hidden px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition font-medium">
                                ← Back
                            </button>
                            <div class="hidden lg:block text-sm text-gray-600">
                                Step <span id="current-step">1</span> of 6
                            </div>
                            <button type="button" id="nextBtn" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium">
                                Next →
                            </button>
                        </div>
                    </div>
    ...
    <style>
        .review-step-container { animation: fadeIn 0.3s ease-in-out; }
        @keyframes fadeIn {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const steps = [
                { id: 1, name: 'Data Anak', icon: '<i class="fas fa-user"></i>' },
                { id: 2, name: 'Data Orang Tua', icon: '<i class="fas fa-people-roof"></i>' },
                { id: 3, name: 'Data Prestasi', icon: '<i class="fas fa-trophy"></i>' },
                { id: 4, name: 'Data Periodik', icon: '<i class="fas fa-chart-bar"></i>' },
                { id: 5, name: 'Dokumen', icon: '<i class="fas fa-file"></i>' },
                { id: 6, name: 'Keputusan', icon: '<i class="fas fa-check-circle"></i>' }
            ];
            ...
            function initSteppers() {
                ...
                steps.forEach(step => {
                    ...
                    desktopStep.className = `stepper-btn w-full text-left px-4 py-3 rounded-lg transition ${step.id === 1 ? 'step-active' : 'hover:bg-[#009ce01a]'}`;
                    ...
                    mobileStep.className = `stepper-btn-mobile flex-shrink-0 py-2 px-3 border-b-2 border-gray-300 transition text-sm whitespace-nowrap ${step.id === 1 ? 'stepper-mobile-active text-[#009CE0]' : 'text-gray-600'}`;
